...
`,[w(">",[u("clear",`
 ...
 `,[ct({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),Ue=O({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(e){return Se("-base-clear",on,me(e,"clsPrefix")),{handleMouseDown(a){a.preventDefault()}}},render(){const{clsPrefix:e}=this;return s("div",{class:`${e}-base-clear`},s(ut,null,{default:()=>{var a,l;return this.show?s("div",{key:"dismiss",class:`${e}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},be(this.$slots.icon,()=>[s(Pe,{clsPrefix:e},{default:()=>s(Qr,null)})])):s("div",{key:"icon",class:`${e}-base-clear__placeholder`},(l=(a=this.$slots).placeholder)===null||l===void 0?void 0:l.call(a))}}))}}),rn=O({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(e,{slots:a}){return()=>{const{clsPrefix:l}=e;return s(Eo,{clsPrefix:l,class:`${l}-base-suffix`,strokeWidth:24,scale:.85,show:e.loading},{default:()=>e.showArrow?s(Ue,{clsPrefix:l,show:e.showClear,onClear:e.onClear},{placeholder:()=>s(Pe,{clsPrefix:l,class:`${l}-base-suffix__arrow`},{default:()=>be(a.default,()=>[s(Zr,null)])})}):null})}}}),nn={paddingTiny:"0 8px",paddingSmall:"0 10px",paddingMedium:"0 12px",paddingLarge:"0 14px",clearSize:"16px"};function an(e){const{textColor2:a,textColor3:l,textColorDisabled:c,primaryColor:i,primaryColorHover:b,inputColor:d,inputColorDisabled:n,borderColor:g,warningColor:v,warningColorHover:x,errorColor:C,errorColorHover:M,borderRadius:_,lineHeight:p,fontSizeTiny:k,fontSizeSmall:F,fontSizeMedium:W,fontSizeLarge:E,heightTiny:N,heightSmall:K,heightMedium:L,heightLarge:y,actionColor:D,clearColor:T,clearColorHover:R,clearColorPressed:I,placeholderColor:j,placeholderColorDisabled:H,iconColor:ie,iconColorDisabled:le,iconColorHover:G,iconColorPressed:se,fontWeight:q}=e;return Object.assign(Object.assign({},nn),{fontWeight:q,countTextColorDisabled:c,countTextColor:l,heightTiny:N,heightSmall:K,heightMedium:L,heightLarge:y,fontSizeTiny:k,fontSizeSmall:F,fontSizeMedium:W,fontSizeLarge:E,lineHeight:p,lineHeightTextarea:p,borderRadius:_,iconSize:"16px",groupLabelColor:D,groupLabelTextColor:a,textColor:a,textColorDisabled:c,textDecorationColor:a,caretColor:i,placeholderColor:j,placeholderColorDisabled:H,color:d,colorDisabled:n,colorFocus:d,groupLabelBorder:`1px solid ${g}`,border:`1px solid ${g}`,borderHover:`1px solid ${b}`,borderDisabled:`1px solid ${g}`,borderFocus:`1px solid ${b}`,boxShadowFocus:`0 0 0 2px ${_e(i,{alpha:.2})}`,loadingColor:i,loadingColorWarning:v,borderWarning:`1px solid ${v}`,borderHoverWarning:`1px solid ${x}`,colorFocusWarning:d,borderFocusWarning:`1px solid ${x}`,boxShadowFocusWarning:`0 0 0 2px ${_e(v,{alpha:.2})}`,caretColorWarning:v,loadingColorError:C,borderError:`1px solid ${C}`,borderHoverError:`1px solid ${M}`,colorFocusError:d,borderFocusError:`1px solid ${M}`,boxShadowFocusError:`0 0 0 2px ${_e(C,{alpha:.2})}`,caretColorError:C,clearColor:T,clearColorHover:R,clearColorPressed:I,iconColor:ie,iconColorDisabled:le,iconColorHover:G,iconColorPressed:se,suffixTextColor:a})}const ln=Lo({name:"Input",common:ht,peers:{Scrollbar:Io},self:an}),xt=gt("n-input"),sn=f("input",`
 max-width: 100%;
 cursor: text;
 line-height: 1.5;
 z-index: auto;
...
`,[u("input, textarea",`
 ...
 `)])]);function cn(e){let a=0;for(const l of e)a++;return a}function ke(e){return e===""||e==null}function un(e){const a=A(null);function l(){const{value:b}=e;if(!b?.focus){i();return}const{selectionStart:d,selectionEnd:n,value:g}=b;if(d==null||n==null){i();return}a.value={start:d,end:n,beforeText:g.slice(0,d),afterText:g.slice(n)}}function c(){var b;const{value:d}=a,{value:n}=e;if(!d||!n)return;const{value:g}=n,{start:v,beforeText:x,afterText:C}=d;let M=g.length;if(g.endsWith(C))M=g.length-C.length;else if(g.startsWith(x))M=x.length;else{const _=x[v-1],p=g.indexOf(_,v-1);p!==-1&&(M=p+1)}(b=n.setSelectionRange)===null||b===void 0||b.call(n,M,M)}function i(){a.value=null}return je(e,i),{recordCursor:l,restoreCursor:c}}const dt=O({name:"InputWordCount",setup(e,{slots:a}){const{mergedValueRef:l,maxlengthRef:c,mergedClsPrefixRef:i,countGraphemesRef:b}=ze(xt),d=V(()=>{const{value:n}=l;return n===null||Array.isArray(n)?0:(b.value||cn)(n)});return()=>{const{value:n}=c,{value:g}=l;return s("span",{class:`${i.value}-input-word-count`},Vo(a.default,{value:g===null||Array.isArray(g)?"":g},()=>[n===void 0?d.value:`${d.value} / ${n}`]))}}}),hn=Object.assign(Object.assign({},Me.props),{bordered:{type:Boolean,default:void 0},type:{type:String,default:"text"},placeholder:[Array,String],defaultValue:{type:[String,Array],default:null},value:[String,Array],disabled:{type:Boolean,default:void 0},size:String,rows:{type:[Number,String],default:3},round:Boolean,minlength:[String,Number],maxlength:[String,Number],clearable:Boolean,autosize:{type:[Boolean,Object],default:!1},pair:Boolean,separator:String,readonly:{type:[String,Boolean],default:!1},passivelyActivated:Boolean,showPasswordOn:String,stateful:{type:Boolean,default:!0},autofocus:Boolean,inputProps:Object,resizable:{type:Boolean,default:!0},showCount:Boolean,loading:{type:Boolean,default:void 0},allowInput:Function,renderCount:Function,onMousedown:Function,onKeydown:Function,onKeyup:[Function,Array],onInput:[Function,Array],onFocus:[Function,Array],onBlur:[Function,Array],onClick:[Function,Array],onChange:[Function,Array],onClear:[Function,Array],countGraphemes:Function,status:String,"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],textDecoration:[String,Array],attrSize:{type:Number,default:20},onInputBlur:[Function,Array],onInputFocus:[Function,Array],onDeactivate:[Function,Array],onActivate:[Function,Array],onWrapperFocus:[Function,Array],onWrapperBlur:[Function,Array],internalDeactivateOnEnter:Boolean,internalForceFocus:Boolean,internalLoadingBeforeSuffix:{type:Boolean,default:!0},showPasswordToggle:Boolean}),fn=O({name:"Input",props:hn,slots:Object,setup(e){const{mergedClsPrefixRef:a,mergedBorderedRef:l,inlineThemeDisabled:c,mergedRtlRef:i}=Ge(e),b=Me("Input","-input",sn,ln,e,a);No&&Se("-input-safari",dn,a);const d=A(null),n=A(null),g=A(null),v=A(null),x=A(null),C=A(null),M=A(null),_=un(M),p=A(null),{localeRef:k}=Yr("Input"),F=A(e.defaultValue),W=me(e,"value"),E=ft(W,F),N=pt(e),{mergedSizeRef:K,mergedDisabledRef:L,mergedStatusRef:y}=N,D=A(!1),T=A(!1),R=A(!1),I=A(!1);let j=null;const H=V(()=>{const{placeholder:t,pair:r}=e;return r?Array.isArray(t)?t:t===void 0?["",""]:[t,t]:t===void 0?[k.value.placeholder]:[t]}),ie=V(()=>{const{value:t}=R,{value:r}=E,{value:h}=H;return!t&&(ke(r)||Array.isArray(r)&&ke(r[0]))&&h[0]}),le=V(()=>{const{value:t}=R,{value:r}=E,{value:h}=H;return!t&&h[1]&&(ke(r)||Array.isArray(r)&&ke(r[1]))}),G=Ke(()=>e.internalForceFocus||D.value),se=Ke(()=>{if(L.value||e.readonly||!e.clearable||!G.value&&!T.value)return!1;const{value:t}=E,{value:r}=G;return e.pair?!!(Array.isArray(t)&&(t[0]||t[1]))&&(T.value||r):!!t&&(T.value||r)}),q=V(()=>{const{showPasswordOn:t}=e;if(t)return t;if(e.showPasswordToggle)return"click"}),Y=A(!1),Fe=V(()=>{const{textDecoration:t}=e;return t?Array.isArray(t)?t.map(r=>({textDecoration:r})):[{textDecoration:t}]:["",""]}),ge=A(void 0),Te=()=>{var t,r;if(e.type==="textarea"){const{autosize:h}=e;if(h&&(ge.value=(r=(t=p.value)===null||t===void 0?void 0:t.$el)===null||r===void 0?void 0:r.offsetWidth),!n.value||typeof h=="boolean")return;const{paddingTop:S,paddingBottom:z,lineHeight:P}=window.getComputedStyle(n.value),X=Number(S.slice(0,-2)),J=Number(z.slice(0,-2)),Z=Number(P.slice(0,-2)),{value:de}=g;if(!de)return;if(h.minRows){const ce=Math.max(h.minRows,1),Oe=`${X+J+Z*ce}px`;de.style.minHeight=Oe}if(h.maxRows){const ce=`${X+J+Z*h.maxRows}px`;de.style.maxHeight=ce}}},De=V(()=>{const{maxlength:t}=e;return t===void 0?void 0:Number(t)});ir(()=>{const{value:t}=E;Array.isArray(t)||Ve(t)});const $e=lr().proxy;function te(t,r){const{onUpdateValue:h,"onUpdate:value":S,onInput:z}=e,{nTriggerFormInput:P}=N;h&&$(h,t,r),S&&$(S,t,r),z&&$(z,t,r),F.value=t,P()}function oe(t,r){const{onChange:h}=e,{nTriggerFormChange:S}=N;h&&$(h,t,r),F.value=t,S()}function Ae(t){const{onBlur:r}=e,{nTriggerFormBlur:h}=N;r&&$(r,t),h()}function Re(t){const{onFocus:r}=e,{nTriggerFormFocus:h}=N;r&&$(r,t),h()}function Be(t){const{onClear:r}=e;r&&$(r,t)}function We(t){const{onInputBlur:r}=e;r&&$(r,t)}function Ee(t){const{onInputFocus:r}=e;r&&$(r,t)}function Le(){const{onDeactivate:t}=e;t&&$(t)}function wt(){const{onActivate:t}=e;t&&$(t)}function yt(t){const{onClick:r}=e;r&&$(r,t)}function Ct(t){const{onWrapperFocus:r}=e;r&&$(r,t)}function kt(t){const{onWrapperBlur:r}=e;r&&$(r,t)}function _t(){R.value=!0}function Pt(t){R.value=!1,t.target===C.value?xe(t,1):xe(t,0)}function xe(t,r=0,h="input"){const S=t.target.value;if(Ve(S),t instanceof InputEvent&&!t.isComposing&&(R.value=!1),e.type==="textarea"){const{value:P}=p;P&&P.syncUnifiedContainer()}if(j=S,R.value)return;_.recordCursor();const z=St(S);if(z)if(!e.pair)h==="input"?te(S,{source:r}):oe(S,{source:r});else{let{value:P}=E;Array.isArray(P)?P=[P[0],P[1]]:P=["",""],P[r]=S,h==="input"?te(P,{source:r}):oe(P,{source:r})}$e.$forceUpdate(),z||lt(_.restoreCursor)}function St(t){const{countGraphemes:r,maxlength:h,minlength:S}=e;if(r){let P;if(h!==void 0&&(P===void 0&&(P=r(t)),P>Number(h))||S!==void 0&&(P===void 0&&(P=r(t)),P<Number(h)))return!1}const{allowInput:z}=e;return typeof z=="function"?z(t):!0}function Mt(t){We(t),t.relatedTarget===d.value&&Le(),t.relatedTarget!==null&&(t.relatedTarget===x.value||t.relatedTarget===C.value||t.relatedTarget===n.value)||(I.value=!1),we(t,"blur"),M.value=null}function zt(t,r){Ee(t),D.value=!0,I.value=!0,wt(),we(t,"focus"),r===0?M.value=x.value:r===1?M.value=C.value:r===2&&(M.value=n.value)}function Ft(t){e.passivelyActivated&&(kt(t),we(t,"blur"))}function Tt(t){e.passivelyActivated&&(D.value=!0,Ct(t),we(t,"focus"))}function we(t,r){t.relatedTarget!==null&&(t.relatedTarget===x.value||t.relatedTarget===C.value||t.relatedTarget===n.value||t.relatedTarget===d.value)||(r==="focus"?(Re(t),D.value=!0):r==="blur"&&(Ae(t),D.value=!1))}function Dt(t,r){xe(t,r,"change")}function $t(t){yt(t)}function At(t){Be(t),qe()}function qe(){e.pair?(te(["",""],{source:"clear"}),oe(["",""],{source:"clear"})):(te("",{source:"clear"}),oe("",{source:"clear"}))}function Rt(t){const{onMousedown:r}=e;r&&r(t);const{tagName:h}=t.target;if(h!=="INPUT"&&h!=="TEXTAREA"){if(e.resizable){const{value:S}=d;if(S){const{left:z,top:P,width:X,height:J}=S.getBoundingClientRect(),Z=14;if(z+X-Z<t.clientX&&t.clientX<z+X&&P+J-Z<t.clientY&&t.clientY<P+J)return}}t.preventDefault(),D.value||Ye()}}function Bt(){var t;T.value=!0,e.type==="textarea"&&((t=p.value)===null||t===void 0||t.handleMouseEnterWrapper())}function Wt(){var t;T.value=!1,e.type==="textarea"&&((t=p.value)===null||t===void 0||t.handleMouseLeaveWrapper())}function Et(){L.value||q.value==="click"&&(Y.value=!Y.value)}function Lt(t){if(L.value)return;t.preventDefault();const r=S=>{S.preventDefault(),Ze("mouseup",document,r)};if(Ne("mouseup",document,r),q.value!=="mousedown")return;Y.value=!0;const h=()=>{Y.value=!1,Ze("mouseup",document,h)};Ne("mouseup",document,h)}function It(t){e.onKeyup&&$(e.onKeyup,t)}function Vt(t){switch(e.onKeydown&&$(e.onKeydown,t),t.key){case"Escape":Ie();break;case"Enter":Ot(t);break}}function Ot(t){var r,h;if(e.passivelyActivated){const{value:S}=I;if(S){e.internalDeactivateOnEnter&&Ie();return}t.preventDefault(),e.type==="textarea"?(r=n.value)===null||r===void 0||r.focus():(h=x.value)===null||h===void 0||h.focus()}}function Ie(){e.passivelyActivated&&(I.value=!1,lt(()=>{var t;(t=d.value)===null||t===void 0||t.focus()}))}function Ye(){var t,r,h;L.value||(e.passivelyActivated?(t=d.value)===null||t===void 0||t.focus():((r=n.value)===null||r===void 0||r.focus(),(h=x.value)===null||h===void 0||h.focus()))}function Ht(){var t;!((t=d.value)===null||t===void 0)&&t.contains(document.activeElement)&&document.activeElement.blur()}function Nt(){var t,r;(t=n.value)===null||t===void 0||t.select(),(r=x.value)===null||r===void 0||r.select()}function jt(){L.value||(n.value?n.value.focus():x.value&&x.value.focus())}function Kt(){const{value:t}=d;t?.contains(document.activeElement)&&t!==document.activeElement&&Ie()}function Ut(t){if(e.type==="textarea"){const{value:r}=n;r?.scrollTo(t)}else{const{value:r}=x;r?.scrollTo(t)}}function Ve(t){const{type:r,pair:h,autosize:S}=e;if(!h&&S)if(r==="textarea"){const{value:z}=g;z&&(z.textContent=`${t??""}\r
`)}else{const{value:z}=v;z&&(t?z.textContent=t:z.innerHTML="&nbsp;")}}function Gt(){Te()}const Xe=A({top:"0"});function qt(t){var r;const{scrollTop:h}=t.target;Xe.value.top=`${-h}px`,(r=p.value)===null||r===void 0||r.syncUnifiedContainer()}let ye=null;it(()=>{const{autosize:t,type:r}=e;t&&r==="textarea"?ye=je(E,h=>{!Array.isArray(h)&&h!==j&&Ve(h)}):ye?.()});let Ce=null;it(()=>{e.type==="textarea"?Ce=je(E,t=>{var r;!Array.isArray(t)&&t!==j&&((r=p.value)===null||r===void 0||r.syncUnifiedContainer())}):Ce?.()}),sr(xt,{mergedValueRef:E,maxlengthRef:De,mergedClsPrefixRef:a,countGraphemesRef:me(e,"countGraphemes")});const Yt={wrapperElRef:d,inputElRef:x,textareaElRef:n,isCompositing:R,clear:qe,focus:Ye,blur:Ht,select:Nt,deactivate:Kt,activate:jt,scrollTo:Ut},Xt=bt("Input",i,a),Je=V(()=>{const{value:t}=K,{common:{cubicBezierEaseInOut:r},self:{color:h,borderRadius:S,textColor:z,caretColor:P,caretColorError:X,caretColorWarning:J,textDecorationColor:Z,border:de,borderDisabled:ce,borderHover:Oe,borderFocus:Jt,placeholderColor:Zt,placeholderColorDisabled:Qt,lineHeightTextarea:eo,colorDisabled:to,colorFocus:oo,textColorDisabled:ro,boxShadowFocus:no,iconSize:ao,colorFocusWarning:io,boxShadowFocusWarning:lo,borderWarning:so,borderFocusWarning:co,borderHoverWarning:uo,colorFocusError:ho,boxShadowFocusError:fo,borderError:po,borderFocusError:bo,borderHoverError:vo,clearSize:mo,clearColor:go,clearColorHover:xo,clearColorPressed:wo,iconColor:yo,iconColorDisabled:Co,suffixTextColor:ko,countTextColor:_o,countTextColorDisabled:Po,iconColorHover:So,iconColorPressed:Mo,loadingColor:zo,loadingColorError:Fo,loadingColorWarning:To,fontWeight:Do,[ve("padding",t)]:$o,[ve("fontSize",t)]:Ao,[ve("height",t)]:Ro}}=b.value,{left:Bo,right:Wo}=jo($o);return{"--n-bezier":r,"--n-count-text-color":_o,"--n-count-text-color-disabled":Po,"--n-color":h,"--n-font-size":Ao,"--n-font-weight":Do,"--n-border-radius":S,"--n-height":Ro,"--n-padding-left":Bo,"--n-padding-right":Wo,"--n-text-color":z,"--n-caret-color":P,"--n-text-decoration-color":Z,"--n-border":de,"--n-border-disabled":ce,"--n-border-hover":Oe,"--n-border-focus":Jt,"--n-placeholder-color":Zt,"--n-placeholder-color-disabled":Qt,"--n-icon-size":ao,"--n-line-height-textarea":eo,"--n-color-disabled":to,"--n-color-focus":oo,"--n-text-color-disabled":ro,"--n-box-shadow-focus":no,"--n-loading-color":zo,"--n-caret-color-warning":J,"--n-color-focus-warning":io,"--n-box-shadow-focus-warning":lo,"--n-border-warning":so,"--n-border-focus-warning":co,"--n-border-hover-warning":uo,"--n-loading-color-warning":To,"--n-caret-color-error":X,"--n-color-focus-error":ho,"--n-box-shadow-focus-error":fo,"--n-border-error":po,"--n-border-focus-error":bo,"--n-border-hover-error":vo,"--n-loading-color-error":Fo,"--n-clear-color":go,"--n-clear-size":mo,"--n-clear-color-hover":xo,"--n-clear-color-pressed":wo,"--n-icon-color":yo,"--n-icon-color-hover":So,"--n-icon-color-pressed":Mo,"--n-icon-color-disabled":Co,"--n-suffix-text-color":ko}}),re=c?vt("input",V(()=>{const{value:t}=K;return t[0]}),Je,e):void 0;return Object.assign(Object.assign({},Yt),{wrapperElRef:d,inputElRef:x,inputMirrorElRef:v,inputEl2Ref:C,textareaElRef:n,textareaMirrorElRef:g,textareaScrollbarInstRef:p,rtlEnabled:Xt,uncontrolledValue:F,mergedValue:E,passwordVisible:Y,mergedPlaceholder:H,showPlaceholder1:ie,showPlaceholder2:le,mergedFocus:G,isComposing:R,activated:I,showClearButton:se,mergedSize:K,mergedDisabled:L,textDecorationStyle:Fe,mergedClsPrefix:a,mergedBordered:l,mergedShowPasswordOn:q,placeholderStyle:Xe,mergedStatus:y,textAreaScrollContainerWidth:ge,handleTextAreaScroll:qt,handleCompositionStart:_t,handleCompositionEnd:Pt,handleInput:xe,handleInputBlur:Mt,handleInputFocus:zt,handleWrapperBlur:Ft,handleWrapperFocus:Tt,handleMouseEnter:Bt,handleMouseLeave:Wt,handleMouseDown:Rt,handleChange:Dt,handleClick:$t,handleClear:At,handlePasswordToggleClick:Et,handlePasswordToggleMousedown:Lt,handleWrapperKeydown:Vt,handleWrapperKeyup:It,handleTextAreaMirrorResize:Gt,getTextareaScrollContainer:()=>n.value,mergedTheme:b,cssVars:c?void 0:Je,themeClass:re?.themeClass,onRender:re?.onRender})},render(){var e,a,l,c,i,b,d;const{mergedClsPrefix:n,mergedStatus:g,themeClass:v,type:x,countGraphemes:C,onRender:M}=this,_=this.$slots;return M?.(),s("div",{ref:"wrapperElRef",class:[`${n}-input`,v,g&&`${n}-input--${g}-status`,{[`${n}-input--rtl`]:this.rtlEnabled,[`${n}-input--disabled`]:this.mergedDisabled,[`${n}-input--textarea`]:x==="textarea",[`${n}-input--resizable`]:this.resizable&&!this.autosize,[`${n}-input--autosize`]:this.autosize,[`${n}-input--round`]:this.round&&x!=="textarea",[`${n}-input--pair`]:this.pair,[`${n}-input--focus`]:this.mergedFocus,[`${n}-input--stateful`]:this.stateful}],style:this.cssVars,tabindex:!this.mergedDisabled&&this.passivelyActivated&&!this.activated?0:void 0,onFocus:this.handleWrapperFocus,onBlur:this.handleWrapperBlur,onClick:this.handleClick,onMousedown:this.handleMouseDown,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd,onKeyup:this.handleWrapperKeyup,onKeydown:this.handleWrapperKeydown},s("div",{class:`${n}-input-wrapper`},pe(_.prefix,p=>p&&s("div",{class:`${n}-input__prefix`},p)),x==="textarea"?s(Oo,{ref:"textareaScrollbarInstRef",class:`${n}-input__textarea`,container:this.getTextareaScrollContainer,theme:(a=(e=this.theme)===null||e===void 0?void 0:e.peers)===null||a===void 0?void 0:a.Scrollbar,themeOverrides:(c=(l=this.themeOverrides)===null||l===void 0?void 0:l.peers)===null||c===void 0?void 0:c.Scrollbar,triggerDisplayManually:!0,useUnifiedContainer:!0,internalHoistYRail:!0},{default:()=>{var p,k;const{textAreaScrollContainerWidth:F}=this,W={width:this.autosize&&F&&`${F}px`};return s(ar,null,s("textarea",Object.assign({},this.inputProps,{ref:"textareaElRef",class:[`${n}-input__textarea-el`,(p=this.inputProps)===null||p===void 0?void 0:p.class],autofocus:this.autofocus,rows:Number(this.rows),placeholder:this.placeholder,value:this.mergedValue,disabled:this.mergedDisabled,maxlength:C?void 0:this.maxlength,minlength:C?void 0:this.minlength,readonly:this.readonly,tabindex:this.passivelyActivated&&!this.activated?-1:void 0,style:[this.textDecorationStyle[0],(k=this.inputProps)===null||k===void 0?void 0:k.style,W],onBlur:this.handleInputBlur,onFocus:E=>{this.handleInputFocus(E,2)},onInput:this.handleInput,onChange:this.handleChange,onScroll:this.handleTextAreaScroll})),this.showPlaceholder1?s("div",{class:`${n}-input__placeholder`,style:[this.placeholderStyle,W],key:"placeholder"},this.mergedPlaceholder[0]):null,this.autosize?s(Ho,{onResize:this.handleTextAreaMirrorResize},{default:()=>s("div",{ref:"textareaMirrorElRef",class:`${n}-input__textarea-mirror`,key:"mirror"})}):null)}}):s("div",{class:`${n}-input__input`},s("input",Object.assign({type:x==="password"&&this.mergedShowPasswordOn&&this.passwordVisible?"text":x},this.inputProps,{ref:"inputElRef",class:[`${n}-input__input-el`,(i=this.inputProps)===null||i===void 0?void 0:i.class],style:[this.textDecorationStyle[0],(b=this.inputProps)===null||b===void 0?void 0:b.style],tabindex:this.passivelyActivated&&!this.activated?-1:(d=this.inputProps)===null||d===void 0?void 0:d.tabindex,placeholder:this.mergedPlaceholder[0],disabled:this.mergedDisabled,maxlength:C?void 0:this.maxlength,minlength:C?void 0:this.minlength,value:Array.isArray(this.mergedValue)?this.mergedValue[0]:this.mergedValue,readonly:this.readonly,autofocus:this.autofocus,size:this.attrSize,onBlur:this.handleInputBlur,onFocus:p=>{this.handleInputFocus(p,0)},onInput:p=>{this.handleInput(p,0)},onChange:p=>{this.handleChange(p,0)}})),this.showPlaceholder1?s("div",{class:`${n}-input__placeholder`},s("span",null,this.mergedPlaceholder[0])):null,this.autosize?s("div",{class:`${n}-input__input-mirror`,key:"mirror",ref:"inputMirrorElRef"}," "):null),!this.pair&&pe(_.suffix,p=>p||this.clearable||this.showCount||this.mergedShowPasswordOn||this.loading!==void 0?s("div",{class:`${n}-input__suffix`},[pe(_["clear-icon-placeholder"],k=>(this.clearable||k)&&s(Ue,{clsPrefix:n,show:this.showClearButton,onClear:this.handleClear},{placeholder:()=>k,icon:()=>{var F,W;return(W=(F=this.$slots)["clear-icon"])===null||W===void 0?void 0:W.call(F)}})),this.internalLoadingBeforeSuffix?null:p,this.loading!==void 0?s(rn,{clsPrefix:n,loading:this.loading,showArrow:!1,showClear:!1,style:this.cssVars}):null,this.internalLoadingBeforeSuffix?p:null,this.showCount&&this.type!=="textarea"?s(dt,null,{default:k=>{var F;const{renderCount:W}=this;return W?W(k):(F=_.count)===null||F===void 0?void 0:F.call(_,k)}}):null,this.mergedShowPasswordOn&&this.type==="password"?s("div",{class:`${n}-input__eye`,onMousedown:this.handlePasswordToggleMousedown,onClick:this.handlePasswordToggleClick},this.passwordVisible?be(_["password-visible-icon"],()=>[s(Pe,{clsPrefix:n},{default:()=>s(en,null)})]):be(_["password-invisible-icon"],()=>[s(Pe,{clsPrefix:n},{default:()=>s(tn,null)})])):null]):null)),this.pair?s("span",{class:`${n}-input__separator`},be(_.separator,()=>[this.separator])):null,this.pair?s("div",{class:`${n}-input-wrapper`},s("div",{class:`${n}-input__input`},s("input",{ref:"inputEl2Ref",type:this.type,class:`${n}-input__input-el`,tabindex:this.passivelyActivated&&!this.activated?-1:void 0,placeholder:this.mergedPlaceholder[1],disabled:this.mergedDisabled,maxlength:C?void 0:this.maxlength,minlength:C?void 0:this.minlength,value:Array.isArray(this.mergedValue)?this.mergedValue[1]:void 0,readonly:this.readonly,style:this.textDecorationStyle[1],onBlur:this.handleInputBlur,onFocus:p=>{this.handleInputFocus(p,1)},onInput:p=>{this.handleInput(p,1)},onChange:p=>{this.handleChange(p,1)}}),this.showPlaceholder2?s("div",{class:`${n}-input__placeholder`},s("span",null,this.mergedPlaceholder[1])):null),pe(_.suffix,p=>(this.clearable||p)&&s("div",{class:`${n}-input__suffix`},[this.clearable&&s(Ue,{clsPrefix:n,show:this.showClearButton,onClear:this.handleClear},{icon:()=>{var k;return(k=_["clear-icon"])===null||k===void 0?void 0:k.call(_)},placeholder:()=>{var k;return(k=_["clear-icon-placeholder"])===null||k===void 0?void 0:k.call(_)}}),p]))):null,this.mergedBordered?s("div",{class:`${n}-input__border`}):null,this.mergedBordered?s("div",{class:`${n}-input__state-border`}):null,this.showCount&&x==="textarea"?s(dt,null,{default:p=>{var k;const{renderCount:F}=this;return F?F(p):(k=_.count)===null||k===void 0?void 0:k.call(_,p)}}):null)}}),pn=f("input-group",`
 display: inline-flex;
 width: 100%;
 flex-wrap: nowrap;
 vertical-align: bottom;
`,[w(">",[f("input",[w("&:not(:last-child)",`
 ...
 border-top-left-radius: 0!important;
 border-bottom-left-radius: 0!important;
 `)])])])])])]),bn={},vn=O({name:"InputGroup",props:bn,setup(e){const{mergedClsPrefixRef:a}=Ge(e);return Se("-input-group",pn,a),{mergedClsPrefix:a}},render(){const{mergedClsPrefix:e}=this;return s("div",{class:`${e}-input-group`},this.$slots)}}),mn={sizeSmall:"14px",sizeMedium:"16px",sizeLarge:"18px",labelPadding:"0 8px",labelFontWeight:"400"};function gn(e){const{baseColor:a,inputColorDisabled:l,cardColor:c,modalColor:i,popoverColor:b,textColorDisabled:d,borderColor:n,primaryColor:g,textColor2:v,fontSizeSmall:x,fontSizeMedium:C,fontSizeLarge:M,borderRadiusSmall:_,lineHeight:p}=e;return Object.assign(Object.assign({},mn),{labelLineHeight:p,fontSizeSmall:x,fontSizeMedium:C,fontSizeLarge:M,borderRadius:_,color:a,colorChecked:g,colorDisabled:l,colorDisabledChecked:l,colorTableHeader:c,colorTableHeaderModal:i,colorTableHeaderPopover:b,checkMarkColor:a,checkMarkColorDisabled:d,checkMarkColorDisabledChecked:d,border:`1px solid ${n}`,borderDisabled:`1px solid ${n}`,borderDisabledChecked:`1px solid ${n}`,borderChecked:`1px solid ${g}`,borderFocus:`1px solid ${g}`,boxShadowFocus:`0 0 0 2px ${_e(g,{alpha:.3})}`,textColor:v,textColorDisabled:d})}const xn={common:ht,self:gn},wn=gt("n-checkbox-group"),yn=()=>s("svg",{viewBox:"0 0 64 64",class:"check-icon"},s("path",{d:"M50.42,16.76L22.34,39.45l-8.1-11.46c-1.12-1.58-3.3-1.96-4.88-0.84c-1.58,1.12-1.95,3.3-0.84,4.88l10.26,14.51  c0.56,0.79,1.42,1.31,2.38,1.45c0.16,0.02,0.32,0.03,0.48,0.03c0.8,0,1.57-0.27,2.2-0.78l30.99-25.03c1.5-1.21,1.74-3.42,0.52-4.92  C54.13,15.78,51.93,15.55,50.42,16.76z"})),Cn=()=>s("svg",{viewBox:"0 0 100 100",class:"line-icon"},s("path",{d:"M80.2,55.5H21.4c-2.8,0-5.1-2.5-5.1-5.5l0,0c0-3,2.3-5.5,5.1-5.5h58.7c2.8,0,5.1,2.5,5.1,5.5l0,0C85.2,53.1,82.9,55.5,80.2,55.5z"})),kn=w([f("checkbox",`
 font-size: var(--n-font-size);
 outline: none;
 cursor: pointer;
 display: inline-flex;
